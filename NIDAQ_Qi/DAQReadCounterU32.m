function readArray = DAQReadCounterU32(taskHandle, numSampsPerChan)
[status, readArray, sampsPerChanRead, CI_reserved] = DAQmxReadCounterU32(taskHandle,int32(numSampsPerChan),-1,uint32(zeros(numSampsPerChan,1)),uint32(numSampsPerChan),int32(0),uint32(0));
if status ~=0
