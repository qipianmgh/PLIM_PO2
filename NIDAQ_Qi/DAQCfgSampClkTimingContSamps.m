function status = DAQCfgSampClkTimingContSamps(taskHandle, source, rate, sampsPerChan)
status = DAQmxCfgSampClkTiming(taskHandle, source, rate, DAQmx_Val_Rising, DAQmx_Val_ContSamps, uint64(sampsPerChan));
if status ~=0
