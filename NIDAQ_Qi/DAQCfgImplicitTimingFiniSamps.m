...
function status = DAQCfgImplicitTimingFiniSamps(taskHandle, sampsPerChan)
status = DAQmxCfgImplicitTiming(taskHandle, DAQmx_Val_FiniteSamps, uint64(sampsPerChan));
if status ~=0
