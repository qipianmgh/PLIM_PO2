function status = DAQCfgSampClkTiming(taskHandle, source, rate, sampleMode, sampsPerChan)
status = DAQmxCfgSampClkTiming(taskHandle, source, rate, DAQmx_Val_Rising, sampleMode, uint64(sampsPerChan));
if status ~=0
